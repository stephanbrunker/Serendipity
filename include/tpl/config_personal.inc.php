    ...
    $res['personal'] =
             array('title' => USERCONF_CAT_PERSONAL,
                   ...
                   'items' => array(array('var'         => 'username',
                                    ...
                                    array('var'         => 'description',
                                          'title'       => USERCONF_DESCRIPTION,
                                          'description' => USERCONF_DESCRIPTION_DESC,
                                          'type'        => 'textarea',
                                          'default'     => '',
                                          'permission'  => 'personalConfiguration'),

                                    array('var'         => 'image',
                                          'title'       => USERCONF_IMAGE,
                                          'description' => USERCONF_IMAGE_DESC,
                                          'type'        => 'media',
                                          'default'     => '',
                                          'permission'  => 'personalConfiguration'),

                                    array('var'         => 'mailimage',
                                          'title'       => MAIL_IMAGE_TO_DISPLAY,
                                          'description' => MAIL_IMAGE_TO_DISPLAY_DESC,
                                          'type'        => 'string',
                                          'default'     => '',
                                          'permission'  => 'personalConfiguration'),

                                    array('var'         => 'xmlimage',
                                          'title'       => XML_IMAGE_TO_DISPLAY,
                                          'description' => XML_IMAGE_TO_DISPLAY_DESC,
                                          'type'        => 'string',
                                          'default'     => '',
                                          'permission'  => 'personalConfiguration'),
