...
/* ADMIN - INDEX.TPL */
@define('SERENDIPITY_ADMIN_SUITE', 'Serendipity智能博客系统');
...
@define('INSTALL_DBPERSISTENT_DESC', '对数据库使用持续连接, 详情参阅 <a href="https://php.net/manual/features.persistent-connections.php" target="_blank">这里</a>，通常不建议使用。');
...
@define('PERMISSION_ADMINUSERSMAINTAINOTHERS', '管理其它群组的会员');
